...
#define STRING_CONFIG_H_AUTHOR "(Sam, Prusam)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 110, 110, 15, 50 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -3.7   // Z offset: -below +above  [the nozzle]
